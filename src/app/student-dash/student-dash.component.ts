...
export class StudentDashComponent implements OnInit {
  ...
  display_info(){
    ...
    .pipe(map(data => {
      ...
      .subscribe(data=> {
        ...
        this.dataService.find_single_student_match_list(this.current_id,"student")
  ...
  get_data(data:any){
    ...
    this.user_current_courses = data[0].coursesRequired //most important 1
    this.user_current_days = data[0].daysRequired //most important 2
